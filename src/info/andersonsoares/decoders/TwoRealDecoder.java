...
public class TwoRealDecoder extends Decoder {

	public TwoRealDecoder(Integer decimalPlaces, Integer baseNumber) {
	...
	public List<Double> decode(Chromosome chromosome) {
        ...
        base = 1;
        for (int i = chromosome.size() - 1; i >= splitIndex + 1; base *= baseNumber)

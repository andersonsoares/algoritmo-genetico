...
package info.andersonsoares.algorithm.mutation.population;
...
public class CHCCataclysmicMutation implements PopulationMutation
{
    ...
    public CHCCataclysmicMutation(Decoder d, FunctionInterface f)
    {
        this.d = d;
        this.f = f;
    }
    ...
    public List<Chromosome> mutate(List<Chromosome> population, double pCM)
    {
        ...
        for (Chromosome chromosome : population)
            if (f.calculate(d.decode(chromosome)) == bestFitness)
